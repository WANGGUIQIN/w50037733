...
_TASK_PROMPTS = {
    ...
    "planning": (
        # IMPORTANT: this few-shot mirrors the training target format produced
        # by data/unified_loader.py:_load_plan_target() byte-for-byte. Any
        # divergence (e.g. stripping u=/v= prefixes, splitting affordance and
        # approach onto separate lines, dropping <END_OF_PLAN>) forces the
        # LoRA-trained model into format collapse. Edit with care.
        ...
        'markdown, no bold. Field layout per step:\n'
        'Scene: <obj1>, <obj2>, ...\n'
        'Step <N>: <action>(<target>)             '
        '# use <action>(<target> -> <destination>) for transport/place/insert/pour\n'
        '  affordance_hint: <functional part description>\n'
        '  affordance: [u=<u>, v=<v>], approach: [x=<x>, y=<y>, z=<z>]\n'
        '  contact: <pred>(<args>) [<role>]; ...\n'
        '  spatial: <pred>(<args>) [<role>]; ...\n'
        '  done_when: <expression>\n'
        '<END_OF_PLAN>\n\n'
        'Numeric requirements:\n'
        '  - u, v are normalized floats in [0.000, 1.000] with THREE decimals '
        '(e.g. [u=0.575, v=0.325], NOT [u=0.58, v=0.32], NOT [575, 325]).\n'
        '  - x, y, z are floats with three decimals.\n'
        '  - The affordance and approach lists are on the SAME line, separated '
        'by ", ". Do not split them.\n'
        ...
        '  affordance: [u=0.350, v=0.480], approach: [x=0.000, y=0.000, z=-1.000]\n'
        ...
        '  affordance: [u=0.320, v=0.510], approach: [x=0.000, y=0.000, z=-1.000]\n'
        ...
        '  affordance: [u=0.620, v=0.550], approach: [x=0.000, y=0.000, z=-1.000]\n'
